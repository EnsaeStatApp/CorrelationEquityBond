...
#### Idée : Cette classe abstraite donne le contrat minimal que doivent respecter tous nos détecteurs de régime. 
#### But : Eviter qu'un detecteur de régime n'implémente pas ces méthodes essentielles, ou sous d'autres noms. 

class RegimeDetector(ABC):
    """
    Interface abstraite pour tout modèle de détection de régimes.
